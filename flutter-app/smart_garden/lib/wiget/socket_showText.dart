...
class socketIO_showtext extends StatefulWidget{
  ...
  @override
  _socketIO_showTextState createState() => _socketIO_showTextState(title,specialChar,notation);
                    ...
                    children: <Widget>[
                     Text(
                      ...
                      checkflag?dataFromSocket.temp:dataFromSocket.hum,
                        style: TextStyle(fontWeight: FontWeight.w200,fontSize: textScale,color: text_color),
                     ),
                      ...
                      Text(this.specialChar,style: TextStyle(fontSize: textScale, fontWeight: FontWeight.w200))
                    ],
                  ),
                ));}
